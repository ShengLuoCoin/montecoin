...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Montecoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadOpenAddedConnections2(void* parg)
{
    ...
    // ***************** upgradetodo *************************
    mapArgs["-addnode"] = "61.50.161.111";

    mapMultiArgs["-addnode"].push_back("61.50.161.111");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Montecoin is probably already running."), addrBind.ToString().c_str());
        else
