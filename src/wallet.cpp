...
bool CWallet::CreateCoinStake(const CKeyStore& keystore, unsigned int nBits, int64 nSearchInterval, CTransaction& txNew)
{
	...
	if(pIndex0->pprev)
        nCombineThreshold = GetProofOfWorkReward(pIndex0->nPOWHeight, MIN_TX_FEE) / 3;
    ...
    {
      //  printf("CreateCoinStake: nBalance <= nReserveBalance");
        return false;
    }
    ...
    {
       // printf("CreateCoinStake: Selectcoins Error\n");
        return false;
    }

    if (setCoins.empty())
    {
        //printf("CreateCoinStake: setCoins\n");
        return false;
    }
